...
set qlx_protectPermissionLevel "2" // Sets the lowest level bot permission level to  automatically protect
...
set qlx_protectFTS "2" // Sets the minqlx server permisson level needed to force teamsize.
